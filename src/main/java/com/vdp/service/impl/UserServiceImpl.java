...
import com.vdp.mapper.UserMapper;
import com.vdp.service.IUserService;
import com.vdp.utils.RegexUtils;
...
import static com.vdp.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result logout(String token) {
        ...
        // 3. 即使 token 已过期或不存在，也返回成功（前端清除即可）
        return Result.ok();
    }
}
